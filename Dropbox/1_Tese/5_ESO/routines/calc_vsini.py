...
def plot_vsini(data, vsini_arr, limbdark, folder_fig, folder_temp,
               ...
               plotchi2_map, lbdc, ltem, llog, lambd, prof, calc_by_fft):
...
# ------------------------------------------------------------------------------
    ...
    inputs = 'eso_demos'  # eso or 'eso_demos'
    calc_by_fft = False  # to calculate vsini by fft
    delta = 200
    plotchi2_map = True
...
# ------------------------------------------------------------------------------
    ...
    for i in range(len(list_stars)):
        ...
        plot_vsini(data=data, vsini_arr=vsini_arr, limbdark=limbdark,
                   ...
                   lambd=lambd, prof=prof, calc_by_fft=calc_by_fft)
